...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self decodeVideoAsset:video_url];
}
...
- (void)decodeVideoAsset:(NSString *)url {
    
    //AVURLAsset *asset = [AVURLAsset URLAssetWithURL:[[NSURL alloc] initFileURLWithPath:url] options:nil];

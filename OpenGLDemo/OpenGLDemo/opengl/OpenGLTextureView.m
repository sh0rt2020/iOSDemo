...
/**
 ...
 @param displayLink 系统提供的定时器（保持和屏幕像素刷新频率一致）
 */
- (void)render:(CADisplayLink *)displayLink {
    ...
    //floor texture
    glActiveTexture(GL_TEXTURE0); //unneccessary
    glBindTexture(GL_TEXTURE_2D, _floorTexture);
    glUniform1i(_textureUniform, 0); //unneccessary
    
    glDrawElements(GL_TRIANGLE_STRIP, sizeof(Indices1)/sizeof(Indices1[0]), GL_UNSIGNED_BYTE, 0);

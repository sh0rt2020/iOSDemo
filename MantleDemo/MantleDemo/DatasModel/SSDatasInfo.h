...
// *  活动、广告
// */
//@interface SSActADInfo : NSObject
//
...
//#pragma mark - 商家配送信息
//@interface SSStoreDeliveryInfo : NSObject
...
//#pragma mark - 配送商家信息
//@interface  SSDeliveryStoreInfo : NSObject
//@property (nonatomic, copy) NSString *ssStoreId;   //书报亭编号
//@property (nonatomic, copy) NSString *ssStoreName;  //书报亭名称
...
//#pragma mark - 报刊、杂志、图书详情
///*
// * 报刊、杂志、图书详情
// */
//@interface SSPublicationInfo : NSObject
//
 ...
 * 分类
 */
//@interface SSCategoryInfo : NSObject
//
//@property (nonatomic, copy) NSString *ssId;            //分类 id
//@property (nonatomic, copy) NSString *ssName;      //分类名字
//@property (nonatomic, copy) NSString *ssType;     //分类标识
//@property (nonatomic, retain) NSArray *ssSubclassArray;     //子类数组
//
//@end
...
@property (nonatomic, copy) NSString *ssName;
